  ...
  return (
    <div className="flex-row rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      {wordpressData.map((post, index) => (
        <div key={index} className="p-8 m-8 mt-0 bg-[#1a1c21] rounded-md">
          {/* I am aware of how dangerous innerHTML is. I am only importing posts from my own Wordpress account :) */}
          <h5
            dangerouslySetInnerHTML={{ __html: post.title }}
            className="mb-2 p-1 text-2xl font-bold tracking-tight text-gray-900 text-white"
          />
          <p
